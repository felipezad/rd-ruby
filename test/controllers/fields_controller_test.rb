...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post fields_url, params: { field: { attribute: @field.attribute, html: @field.html, user_id: @field.user_id, value: @field.value } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { attribute: @field.attribute, html: @field.html, user_id: @field.user_id, value: @field.value } }
